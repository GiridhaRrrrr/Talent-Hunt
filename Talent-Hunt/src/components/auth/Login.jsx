      ...
      <div className="min-h-screen max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 lg:border-l lg:border-gray-200 lg:pl-8">
            <div className="mb-6">
              <h3 className="text-lg font-medium text-gray-900 mb-3">Sign in with</h3>
            ...
            <div className="mt-6 border-t border-gray-200 pt-6">
              <p className="text-center text-sm text-gray-600">
                ...
                <Link to="/signup" className="font-medium text-indigo-600 hover:text-indigo-500 transition-colors duration-200 ml-1">
                  Sign up
                </Link>
              </p>
            </div>
